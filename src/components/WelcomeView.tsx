...
const WelcomeView = ({ onLogin }: WelcomeViewProps) => {
    ...
    const handleUsernameSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            saveStoredUser(user); // Save simple session
            onLogin(user);
        } catch (err) {
    ...
    const handleGoogleLogin = () => {
        // Mock for now, but UI should support it
    ...
    return (
        ...
        "
            ...
            >
                {/* SVG Icon simplified/omitted for brevity, assume same one */}
